...
import com.ctgu.map.util.DensityUtils;
import com.ctgu.map.util.NaviUtil;
import com.ctgu.map.view.AMapCameraOverlay;
import com.ctgu.map.view.CarOverlay;
import com.ctgu.map.view.DriveWayLinear;
import com.ctgu.map.view.NextTurnTipView;
import com.ctgu.map.view.TrafficProgressBar;
import com.ctgu.map.view.ZoomInIntersectionView;

import java.util.List;

/**
 * 包名： com.ctgu.map.activity.custom
 * <p>
 * 创建时间：2018/4/24
 * 项目名称：NaviDemo
 *
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aMap.setOnMapLoadedListener(new AMap.OnMapLoadedListener() {
            ...
            public void onMapLoaded() {
                ...
                carOverlay = new CarOverlay(com.ctgu.map.activity.AllCustomNaviActivity.this, mAMapNaviView);
