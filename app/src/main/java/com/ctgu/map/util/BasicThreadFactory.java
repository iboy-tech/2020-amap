...
public class BasicThreadFactory implements ThreadFactory {
     ...
     * 创建器类
     */
    public static class Builder implements IBuilder<com.ctgu.map.util.BasicThreadFactory> {
         ...
         */
        @Override
        public com.ctgu.map.util.BasicThreadFactory build() {
            com.ctgu.map.util.BasicThreadFactory factory = new com.ctgu.map.util.BasicThreadFactory(this);
            reset();
            return factory;
        }
    }
